...
It is adapted from Li et al., 2021 (see Sources).
...
2. **Select Dataset**: Choose your cancer type from GDC datasets (e.g., GDC TCGA-LUAD, GDC TCGA-BRCA)
3. **Download Multi-Omics Data**:
   ...
   - Somatic Mutations (SNVs and small InDels)
   - Clinical/Phenotype Data

More information in the [DATA_PREPARATION.md](DATA_PREPARATION.md) file using the notebooks in /Preprocessing_input_files.
...
2. Use preprocessing notebooks in `Preprocessing_input_files/` to format data like in DATA_PREPARATION.md
...
This project uses [PyTorch Geometric](https://pytorch-geometric.readthedocs.io/) for graph neural network implementations.  
The GCN architecture is based on [Kipf & Welling (2017)](https://arxiv.org/abs/1609.02907).
